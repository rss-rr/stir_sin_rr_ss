...
public class SubjectModel {
    ...
    public void update(SubjectBean bean) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE ST_SUBJECT SET subject_Name=?, Course_NAME=?,Description=?,Course_ID=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
